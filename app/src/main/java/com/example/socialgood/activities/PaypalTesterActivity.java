 ...
 */
public class PaypalTesterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paypal_tester);
    ...
    public void onBuyPressed(View pressed) {
        ...
        PayPalPayment donationPayment = getNewDonation(PayPalPayment.PAYMENT_INTENT_SALE, amount);

        /*
         * See getStuffToBuy(..) for examples of some available payment options.
         */

        Intent intent = new Intent(PaypalTesterActivity.this, PaymentActivity.class);
    ...
    private PayPalPayment getNewDonation(String paymentIntent, int amount) {
